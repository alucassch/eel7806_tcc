...
class Zipformer(EncoderInterface):
    ...
    def __init__(
        ...
        pos_dim: int = 4,
        pos_intermediate_ctc_output: int = 0,
        ...
        assert pos_intermediate_ctc_output > 0, pos_intermediate_ctc_output
        assert pos_intermediate_ctc_output <= len(encoder_dims), (
            pos_intermediate_ctc_output,
            len(encoder_dims),
        )

        self.pos_intermediate_ctc_output = pos_intermediate_ctc_output
    ...
    def forward(
        ...
        x_intermediate_ctc_output = self.downsample_output(
            outputs[self.pos_intermediate_ctc_output - 1]
        )
        ...
        x_intermediate_ctc_output = x_intermediate_ctc_output.permute(1, 0, 2)

        return x, x_intermediate_ctc_output, lengths
